...
<form role="search" method="get" class="search-form relative group" action="<?php echo esc_url( home_url( '/' ) ); ?>">
    ...
    <div id="live-search-results" class="absolute z-50 w-full mt-2 bg-white rounded-2xl shadow-2xl dark:bg-slate-900 hidden max-h-96 overflow-y-auto border border-slate-200 dark:border-slate-800"></div>
</form>
